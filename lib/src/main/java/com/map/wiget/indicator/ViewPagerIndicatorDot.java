package com.map.wiget.indicator;
...
@ViewPager.DecorView
public class ViewPagerIndicatorDot extends ViewGroup {
    ...
    public ViewPagerIndicatorDot(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public ViewPagerIndicatorDot(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public ViewPagerIndicatorDot(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ViewPagerIndicatorDot(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
